...
// Source: app\src\product\model\product.go

// Package mock_model is a generated GoMock package.
package mock_model

import (
	model "loja/app/src/product/model"
	reflect "reflect"
...
func (m *MockProductServiceInterface) Create(name string, price float64) (model.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", name, price)
	ret0, _ := ret[0].(model.ProductInterface)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Disable mocks base method.
func (m *MockProductServiceInterface) Disable(product model.ProductInterface) (model.ProductInterface, error) {
	m.ctrl.T.Helper()
...
// Enable mocks base method.
func (m *MockProductServiceInterface) Enable(product model.ProductInterface) (model.ProductInterface, error) {
	m.ctrl.T.Helper()
...
func (m *MockProductServiceInterface) Get(id string) (model.ProductInterface, error) {
	m.ctrl.T.Helper()
...
// Get mocks base method.
func (m *MockProductReaderInterface) Get(id string) (model.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(model.ProductInterface)
	ret1, _ := ret[1].(error)
...
func (m *MockProductWriterInterface) Save(product model.ProductInterface) (model.ProductInterface, error) {
	m.ctrl.T.Helper()
...
// Get mocks base method.
func (m *MockProductPersistenceInterface) Get(id string) (model.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(model.ProductInterface)
	ret1, _ := ret[1].(error)
...
// Save mocks base method.
func (m *MockProductPersistenceInterface) Save(product model.ProductInterface) (model.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Save", product)
	ret0, _ := ret[0].(model.ProductInterface)
	ret1, _ := ret[1].(error)
